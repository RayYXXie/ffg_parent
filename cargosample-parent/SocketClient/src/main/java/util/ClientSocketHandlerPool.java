...
public class ClientSocketHandlerPool {
	...
	public static final ExecutorService threadPool = new ThreadPoolExecutor(coreSize, maxSize, aliveTime, TimeUnit.MILLISECONDS,new LinkedBlockingDeque<Runnable>() );
