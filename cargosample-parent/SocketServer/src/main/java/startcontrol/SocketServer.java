...
public class SocketServer {
	...
	public void start() throws Exception {
		...
		while (true) {
			try {
//				FIRST: if (controlcount == 0) {
//					HttpClient httpclient = new DefaultHttpClient();
//					String url = "http://localhost:8080/SocketClient/HandlerServlet?id="
//							+ id;
...
//								String updateSql = "update tb_socketcommunicationconfirm set communication_status='2' where id="
//										+ id;
...
//									handler.closeAll();
//									throw new Exception(
//											"fail to communicate with the socketclient !");
//								}
//
//							}
//						}
...
//				}
				...
				System.out.println("totalNum :" + totalNum + "  count: "
						+ count);
